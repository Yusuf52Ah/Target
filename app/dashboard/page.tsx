...
import { PortfolioForm } from "@/features/profile/components/portfolio-form";
import { ProfileUpdateForm } from "@/features/profile/components/profile-update-form";
import { WalletTopupForm } from "@/features/orders/components/wallet-topup-form";
...
export default async function DashboardPage() {
  ...
  if (!isLocalAuthMode() && (session.user.role === "SPECIALIST" || session.user.role === "ADMIN")) {
